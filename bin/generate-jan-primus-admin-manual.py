...
def build_manual() -> None:
    ...
    section(story, "4", "Evenementen en eventdagen", "Een administrator maakt een evenement eerst als concept. Elk account met een gekoppeld ledenprofiel - ook een administrator - kan zich pas registreren zodra het evenement gepubliceerd is.")
    ...
    section(story, "5", "Eventinschrijvingen", "Met een eventinschrijving bedoelen we dat een gebruiker zichzelf voor het evenement en één of meerdere eventdagen geregistreerd heeft. Een administrator kan dit eveneens doen via Mijn deelname op de evenementpagina.")
    ...
    section(story, "6", "Shifts kiezen en toewijzen", "Zowel het lid als de administrator speelt een rol. Iedere geregistreerde deelnemer kan gepubliceerde shifts kiezen; de administrator kan daarnaast toewijzen en behoudt het laatste woord.")
    story.append(process_table([("Deelnemer kiest", "Een lid of administrator ziet de beschikbare shifts op de eventdagen waarvoor die zelf geregistreerd is."), ("Admin neemt deel", "Een administrator gebruikt Mijn shifttoewijzing om voor zichzelf een shift te kiezen of een keuze in te trekken."), ("Admin wijst toe", "De administrator kan een andere geschikte geregistreerde deelnemer rechtstreeks aan een shift koppelen."), ("Beoordelen", "Controleer capaciteit, functie, locatie en eventuele andere shiftkeuzes."), ("Override", "De administrator kan de keuze aanpassen, verplaatsen, bevestigen, op reserve zetten of annuleren."), ("Wijziging", "Wanneer shiftgegevens wijzigen, krijgen alle leden op die shift automatisch de bijgewerkte informatie."), ("Planning", "Controleer het uiteindelijke persoonlijke shiftoverzicht van de deelnemer.")]))
